...
draw_text(argument1,yp,object_get_name(p.object_index)+" @@@ "+string(argument0)+" ###-> "+string(p))
if p.object_index!=obj_uiZ_controller then{
draw_text(700,yp,": @"+string(p)+"   depth: "+string(p.depth)+"   depth: "+string(p.depth)+"   listpos: "+string(p.listpos))
}
