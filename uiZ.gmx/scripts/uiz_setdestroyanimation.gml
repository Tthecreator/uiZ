///uiz_setdestroyanimation(id,x function, yfunction, alphafunction, time)
/*
Can change the results that occur when using the function uiz_destroyobject_animation_default(id) By default if this function isn't called on an object the animation will be like: uiz_setdestroyanimation(window,uiz_straight,uiz_straight,uiz_straight,0.5);
