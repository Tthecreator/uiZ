///uiz_drawscrollbar_horizontal_step(rx,ry,rlx,rly,scrollbarsprite,scrollbarcolor,scrollbarbacktexturemode,scroll,scrolllines,middlemousescroll,scrollspeed)
