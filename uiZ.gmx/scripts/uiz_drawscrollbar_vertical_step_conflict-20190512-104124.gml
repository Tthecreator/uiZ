///uiz_drawscrollbar_vertical_step(rx,ry,rlx,rly,scroll,scrolllines,middlemousescroll,scrollspeed)
...
//left button
if scrollsel=-1 and uiz_getmouse_y()>argument1 and uiz_getmouse_y()<argument1+cwidth then{
...
if scrollsel=-1 and uiz_getmouse_y()>argument3-cwidth and uiz_getmouse_y()<argument3 then{
if mouse_check_button(mb_left) then{
scroll=clamp(scroll+argument7,0,argument5);
mstate=4;
}else{
