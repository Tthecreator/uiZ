...
if l="" then{
uiz_xml_writetag_at(global.xml,0,"horizontal","","divisions","1","size","1","sizetype",string(xtra),"name","frame: 1 xtra")
uiz_des_framewindow_save()
}else{
uiz_xml_addfile_string(global.xml,l,d,v)}
*/
...
uiz_xml_loadfile_addto(global.xml,f)
ini_close()
}
