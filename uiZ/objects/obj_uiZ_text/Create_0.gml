...
//#objectversion 1.0
uiz_objinit()
color=c_black//c//text color//
text=""//s//text//
center=1//b//center//
font=-1//f//font//
halign=fa_left//v//halign//
valign=fa_top//v//valign//
multiline=false//b//multi line string//
hasbackground=false//b//give this object a background or just keep it plain text//
drawtext=""
