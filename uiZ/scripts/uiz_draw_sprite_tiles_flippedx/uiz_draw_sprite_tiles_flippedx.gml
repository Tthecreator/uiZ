/// @description uiz_draw_sprite_tiles_flippedx(sprite, img, x1, y1, x2, y2, repeatX, repeatY, color, alpha)
/// @param sprite
/// @param  img
/// @param  x1
/// @param  y1
...
/// @param  color
/// @param  alpha
function uiz_draw_sprite_tiles_flippedx(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9) {
	/*
