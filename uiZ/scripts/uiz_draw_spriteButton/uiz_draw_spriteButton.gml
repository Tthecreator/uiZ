/// @description uiz_draw_spriteButton(x1,y1,x2,y2,color,oncolor,incolor,sprite,alpha)
/// @param x1
/// @param y1
/// @param x2
/// @param y2
...
/// @param sprite
/// @param alpha
function uiz_draw_spriteButton(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8) {
	/*
