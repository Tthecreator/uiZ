/// @description uiz_drawscrollbar_vertical_step(rx,ry,rlx,rly,scroll,scrolllines,middlemousescroll,scrollspeed,animation,animationtime)
/// @param rx
/// @param ry
/// @param rlx
/// @param rly
...
/// @param animation
/// @param animationtime
function uiz_drawscrollbar_vertical_step(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9) {
	...
	*/
	...
	//scroll=clamp(scroll+argument7,0,argument5)
	    if twn_fac=1 then{//not busy doing an animation
			...
			//sdbm("twn_test",argument4[@uiz_drawscrollbar_struct.uiz_dsb_tween_scroll_to],argument7,argument5,scroll,argument4[@uiz_drawscrollbar_struct.uiz_dsb_tween_scroll_from])
