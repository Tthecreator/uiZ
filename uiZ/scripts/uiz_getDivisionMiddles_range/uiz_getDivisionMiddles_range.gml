/// @description uiz_getDivisionMiddles_range(left, right, divisions, square)
/// @param left
/// @param  right
/// @param  divisions
/// @param  square
function uiz_getDivisionMiddles_range(argument0, argument1, argument2, argument3) {
	...
	return (argument3+0.5)*(argument1-argument0)/argument2+argument0
