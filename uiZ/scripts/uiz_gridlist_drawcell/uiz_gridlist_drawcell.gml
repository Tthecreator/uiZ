/// @description uiz_gridlist_drawcell(column,row,x,y,w,INTERAL UIZ SCRIPT DO NOT USE)
/// @param column
/// @param row
/// @param x
/// @param y
/// @param w
/// @param INTERAL UIZ SCRIPT DO NOT USE
///INTERNAL UIZ FUNCTION DO NOT USE
function uiz_gridlist_drawcell(argument0, argument1, argument2, argument3, argument4) {
	var row=argument1;
	var col=argument0;
	var wx=argument2;
	var wy=argument3;
	...
	if is_real(t) and sprite_exists(t) then {
	    ...
	    draw_text(wx + textmargin, wy+h/2, string_hash_to_newline(uiz_getText_contained(string(t),w)))
