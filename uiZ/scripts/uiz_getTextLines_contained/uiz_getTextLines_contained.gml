/// @description uiz_getTextLines_contained(string, width, height)
/// @param string
/// @param  width
/// @param  height
function uiz_getTextLines_contained(argument0, argument1, argument2) {
	...
	*/
	...
	var lineheight = string_height(string_hash_to_newline("|"));
	var lines = 0;
	...
	for (i = 1; i <= sz; i++) {
	    ...
	    or ca = $0A then{
	        ...
	        var totlenght = string_width(string_hash_to_newline(line))
	            ...
	            if osl = 1 then {
	                ...
	                for (var e = osl; e > 1; e--) {
	                    ...
	                    or thisstr = ")" then{
	                        ...
	                        if string_width(string_hash_to_newline(sc)) <= width then {
	                            break;
	                        }
	                    }
	                }
            
	            while (string_width(string_hash_to_newline(sc)) > width and string_length(sc) > 1) {
	                osl--;
	                sl--;
