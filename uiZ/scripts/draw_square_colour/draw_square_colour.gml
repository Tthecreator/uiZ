/// @description draw_square_colour(x1,y1,x2,y2,color1,color2,color3,color4,outline,alpha)
/// @param x1
/// @param y1
/// @param x2
/// @param y2
...
/// @param outline
/// @param alpha
function draw_square_colour(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9) {
	/*
