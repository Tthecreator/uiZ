/// @description uiz_animation_objectresize_legacy(object,posinframex,posinframey,setpointx,setpointy,newx,newy,newwidth,newheight,animationtype,formulatype or animationtimepoints,speed)
/// @param object
/// @param posinframex
/// @param posinframey
/// @param setpointx
...
/// @param newheight
/// @param animationtype
/// @param formulatype or animationtimepoints
/// @param speed
function uiz_animation_objectresize_legacy(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9, argument10, argument11) {
