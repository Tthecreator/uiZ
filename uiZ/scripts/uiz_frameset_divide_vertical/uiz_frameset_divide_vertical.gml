/// @description uiz_frameset_divide_vertical(object,divisionval,valuetype[px dp or fc],divisionval,valuetype[px dp or fc],........)
/// @param object
/// @param divisionval
...
/// @param valuetype[px dp or fc]
/// @param ........
function uiz_frameset_divide_vertical() {
	/*
