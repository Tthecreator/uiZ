/// @description uiz_xml_addtreeintree_part(file,xtratree,nothing,lastistag,start,end,handlepart)
/// @param file
/// @param xtratree
/// @param nothing
/// @param lastistag
...
/// @param end
/// @param handlepart
function uiz_xml_addtreeintree_part(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
