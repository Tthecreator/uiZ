/// @description uiz_mouse_isOver_object_leftCheck(object)
/// @param object
function uiz_mouse_isOver_object_leftCheck(argument0) {
	/*
	...
	If you want to check for the object you're working on, you can use "uiz_mouse_isOver_object_leftCheck(id)" 
	*/
