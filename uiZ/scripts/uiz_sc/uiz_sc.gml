/// @description uiz_sc(time in seconds)
/// @param time in seconds
function uiz_sc(argument0) {
	/*
	...
	Considering that, it would take a counter exactly 1 second to reach a value of one if that timer whould increase by 1/30th every step.
