/// @description uiz_drawscrollbar_horizontal_step(rx,ry,rlx,rly,scroll,scrolllines,middlemousescroll,scrollspeed,animation,animationtime)
/// @param rx
/// @param ry
/// @param rlx
/// @param rly
...
/// @param animation
/// @param animationtime
function uiz_drawscrollbar_horizontal_step(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9) {
