/// @description uiz_xml_switch(file,switch1,switch2,alsoinfotype,alsoinfo) switches two tag/folder names and switches them
/// @param file
/// @param switch1
/// @param switch2
/// @param alsoinfotype
/// @param alsoinfo
function uiz_xml_switch(argument0, argument1, argument2, argument3, argument4) {
