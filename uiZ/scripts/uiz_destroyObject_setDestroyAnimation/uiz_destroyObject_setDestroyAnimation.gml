/// @description uiz_destroyObject_setDestroyAnimation(instanceid, xFunction, yFunction, alphaFunction, time)
/// @param instanceid
/// @param  xFunction
/// @param  yFunction
/// @param  alphaFunction
/// @param  time
function uiz_destroyObject_setDestroyAnimation(argument0, argument1, argument2, argument3, argument4) {
	/*
