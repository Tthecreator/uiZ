/// @description uiz_drawscrollbar_horizontal(rx,ry,rlx,rly,scrollbarsprite,scrollbarcolor,scrollbarbacktexturemode,scroll,scrolllines,middlemousescroll,scrollspeed)
/// @param rx
/// @param ry
/// @param rlx
/// @param rly
...
/// @param scrollspeed
function uiz_drawscrollbar_horizontal_legacy(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9, argument10) {
	...
	*/
	...
	var scroll = uiz_drawscrollbar_getScroll(argument7);
	...
	//if domousescroll=1;
	var scrollsel = argument7[@uiz_drawscrollbar_struct.uiz_dsb_scrollsel];
	...
	argument7[@uiz_drawscrollbar_struct.uiz_dsb_scroll] = scroll;
	argument7[@uiz_drawscrollbar_struct.uiz_dsb_scrollsel] = scrollsel;
