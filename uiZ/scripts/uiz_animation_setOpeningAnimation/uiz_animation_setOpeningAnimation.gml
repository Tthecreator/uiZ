/// @description uiz_animation_setOpeningAnimation(id,xfunction,yfunction,alphafunction,speed,changeDestroy)
/// @param id
/// @param xfunction
/// @param yfunction
/// @param alphafunction
/// @param speed
/// @param changeDestroy
function uiz_animation_setOpeningAnimation(argument0, argument1, argument2, argument3, argument4, argument5) {
	/*
