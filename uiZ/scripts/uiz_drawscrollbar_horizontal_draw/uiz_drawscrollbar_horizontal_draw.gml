/// @description uiz_drawscrollbar_horizontal_draw(rx,ry,rlx,rly,scrollbarsprite,scrollbarcolor,scrollbarbacktexturemode,scroll,scrolllines)
/// @param rx
/// @param ry
/// @param rlx
/// @param rly
...
/// @param scroll
/// @param scrolllines
function uiz_drawscrollbar_horizontal_draw(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8) {
