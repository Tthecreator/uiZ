/// @description uiz_drawdslist_updateviews(old,newx,newy,newlx,newly,osel,nsel)
/// @param old
/// @param newx
/// @param newy
/// @param newlx
...
/// @param osel
/// @param nsel
function uiz_drawdslist_updateviews(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
