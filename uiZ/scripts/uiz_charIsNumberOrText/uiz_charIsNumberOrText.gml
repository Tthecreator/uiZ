/// @description uiz_charIsNumberOrText(char)
/// @param char
function uiz_charIsNumberOrText(argument0) {
	/*
	...
	*/
	var c=ord(argument0);
	if (c>=$30 and c<=$39) or (c>=$41 and c<=$5a) or (c>=$61 and c<=$7a) then{return 1;}else{return 0;}
