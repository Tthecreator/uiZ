/// @description uiz_frameset_setFrameSize(divisionid,frame where 0 is the first frame top/left,value,valuetype[px dp fc xtra])
/// @param divisionid
/// @param frame where 0 is the first frame top/left
/// @param value
/// @param valuetype[px dp fc xtra]
function uiz_frameset_setFrameSize(argument0, argument1, argument2, argument3) {
	/*
