/// @description uiz_draw_sprite_tiles(sprite, img, x1, y1, x2, y2, repeatx, repeaty, color, alpha, outerEdgeX, outerEdgeY)
/// @param sprite
/// @param  img
/// @param  x1
/// @param  y1
...
/// @param  outerEdgeX
/// @param  outerEdgeY
function uiz_draw_sprite_tiles(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9, argument10, argument11) {
	/*
