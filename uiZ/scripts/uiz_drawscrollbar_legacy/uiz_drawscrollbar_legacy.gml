/// @description uiz_drawscrollbar(rx,ry,rlx,rly,scrollbarsprite,scrollbarcolor,scrollbarbacktexturemode,scroll,scrolllines,middlemousescroll,scrollspeed)
/// @param rx
/// @param ry
/// @param rlx
/// @param rly
/// @param scrollbarsprite
/// @param scrollbarcolor
/// @param scrollbarbacktexturemode
/// @param scroll
/// @param scrolllines
/// @param middlemousescroll
/// @param scrollspeed
function uiz_drawscrollbar_legacy(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9, argument10) {
	/*
	...
	*/
	...
	return uiz_drawscrollbar_horizontal_legacy(argument0,argument1,argument2,argument3,argument4,argument5,argument6,argument7,argument8,argument9,argument10)
	}else{
	return uiz_drawscrollbar_vertical_legacy(argument0,argument1,argument2,argument3,argument4,argument5,argument6,argument7,argument8,argument9,argument10)
	}
