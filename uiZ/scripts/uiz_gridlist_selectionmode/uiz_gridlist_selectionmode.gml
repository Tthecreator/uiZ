/// @description uiz_gridlist_selectionmode(instanceid,selectionmode[2],keepselection[false])
/// @param instanceid
/// @param selectionmode[2]
/// @param keepselection[false]
function uiz_gridlist_selectionmode(argument0, argument1, argument2) {
	/*
