/// @description uiz_treelist_drawEntry(itemHandle,ypos,rx,rlx)
/// @param itemHandle
/// @param ypos
/// @param rx
/// @param rlx
function uiz_treelist_drawEntry(argument0, argument1, argument2, argument3) {
	...
	if enabled {
	    ...
	    //boxadd += h+margin;
	    draw_set_color(tcol);
	    draw_text(rx+boxadd,ry + hi,string_hash_to_newline(name));
