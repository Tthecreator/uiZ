/// @description draw_square_rounded_colour_outlined(x1,y1,x2,y2,color1,color2,color3,color4,alpha,xstretch,ystretch,thickness)
/// @param x1
/// @param y1
/// @param x2
/// @param y2
...
/// @param ystretch
/// @param thickness
function draw_square_rounded_colour_outlined(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9, argument10, argument11) {
	/*
