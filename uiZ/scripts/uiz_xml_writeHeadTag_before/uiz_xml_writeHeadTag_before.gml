/// @description uiz_xml_writeHeadTag_before(file,at,tagname,[tagattributename,tagattributeinfo,......])
/// @param file
/// @param at
/// @param tagname
...
/// @param ......]
function uiz_xml_writeHeadTag_before() {
	//writes a tag before the given taghandle (argument1 at)
	...
	if h > -1 and(argument_count mod 2) = 1 then {
	    eh = h//h-1;//uiz_xml_gethandleshortend(argument[0], h)
