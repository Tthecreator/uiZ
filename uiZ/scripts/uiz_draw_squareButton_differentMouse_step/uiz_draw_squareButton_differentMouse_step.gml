/// @description uiz_draw_squareButton_differentMouse_step(mx1,my1,mx2,my2)
/// @param mx1
/// @param my1
/// @param mx2
/// @param my2
function uiz_draw_squareButton_differentMouse_step(argument0, argument1, argument2, argument3) {
	/*
