/// @description uiz_text_setmultiline(instanceid,enable multi line support[false])
/// @param instanceid
/// @param enable multi line support[false]
function uiz_text_setmultiline(argument0, argument1) {
