/// @description uiz_drawscrollbar_vertical(frx,fry,frlx,frly,scrollbarsprite,scrollbarcolor,scrollbarbacktexturemode,scroll,scrolllines,middlemousescroll,scrollspeed)
/// @param frx
/// @param fry
/// @param frlx
/// @param frly
...
/// @param scrollspeed
function uiz_drawscrollbar_vertical_legacy(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9, argument10) {
