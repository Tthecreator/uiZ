/// @description uiz_frameset_divide_objects_horizontal(object, divisionval, valuetype[px dp or fc], objectType, divisionval, valuetype[px dp or fc], objectType,........)
/// @param object
/// @param  divisionval
...
/// @param  objectType
/// @param ........
function uiz_frameset_divide_objects_horizontal() {
	/*
