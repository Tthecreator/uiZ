/// @description uiz_framedivision_part_mid(begpartid,object,divisionval,valuetype[px dp or fc],objectType)
/// @param begpartid
/// @param object
/// @param divisionval
/// @param valuetype[px dp or fc]
/// @param objectType
function uiz_framedivision_part_mid(argument0, argument1, argument2, argument3, argument4) {
	/*
