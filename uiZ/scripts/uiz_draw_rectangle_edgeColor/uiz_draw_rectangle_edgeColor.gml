/// @description uiz_draw_rectangle_edgeColor(x1, y1, x2, y2, color1, color2, color3, color4, alpha, thickness)
/// @param x1
/// @param  y1
/// @param  x2
/// @param  y2
...
/// @param  alpha
/// @param  thickness
function uiz_draw_rectangle_edgeColor(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9) {
