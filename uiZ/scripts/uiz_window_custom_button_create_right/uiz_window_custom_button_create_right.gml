/// @description uiz_wndow_custom_button_create_right(window,sprite,color_normal,color_over,color_in,script)
/// @param window
/// @param sprite
/// @param color_normal
/// @param color_over
/// @param color_in
/// @param script
function uiz_window_custom_button_create_right(argument0, argument1, argument2, argument3, argument4, argument5) {
