/// @description check all needed shortcuts
function uiz_stringbox_checkKeys() {
	...
	if(keyboard_check(vk_control)){
	    ...
	    if keyboard_check(vk_backspace) && typepos_real>0 then{
	        uiz_stringbox_typer_remainInView();
	        var removedlength=string_width(string_hash_to_newline(string_char_at(str_real,typepos_real)));
