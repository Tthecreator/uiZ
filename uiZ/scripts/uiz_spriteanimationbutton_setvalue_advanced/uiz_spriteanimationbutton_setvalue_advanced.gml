/// @description uiz_spriteanimationbutton_setvalue_advanced(instance id,linearvalue,tovalue,update)
/// @param instance id
/// @param linearvalue
/// @param tovalue
/// @param update
function uiz_spriteanimationbutton_setvalue_advanced(argument0, argument1, argument2, argument3) {
	/*
