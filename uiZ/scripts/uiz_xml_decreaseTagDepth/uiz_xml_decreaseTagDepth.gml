/// @description uiz_xml_decreaseTagDepth(usexml, taghandle, levelsToDecrease)
/// @param usexml
/// @param  taghandle
/// @param  levelsToDecrease
function uiz_xml_decreaseTagDepth(argument0, argument1, argument2) {
	//takes xml like this
	//<test1>
	//  <test2>
	//      <taghandle></taghandle>
