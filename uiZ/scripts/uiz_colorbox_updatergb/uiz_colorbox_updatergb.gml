/// @description uiz_colorbox_updatergb(update r?, update g?,update b?, update values?, direct?)
/// @param update r?
/// @param  update g?
/// @param update b?
/// @param  update values?
/// @param  direct?
function uiz_colorbox_updatergb(argument0, argument1, argument2, argument3, argument4) {
	var old_r = r;
	var old_g = g;
	var old_b = b;
	var old_h = h;
