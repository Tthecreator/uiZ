/// @description uiz_getText_contained(string, width)
/// @param string
/// @param  width
function uiz_getText_contained(argument0, argument1) {
	/*
	...
	*/
	//go trough chars
	    ...
	    total_width = 0;
	    dots="..."
	    width_dots = width - string_width(string_hash_to_newline(dots));
	    dots_pos=0;
	    i_last=0;
	    str_dots="";
	    for(var i=1;i<=length;i++){
	        ...
	        if (byte>0){
	            ...
	            if bytes>0 then{
	                ...
	                for(var e=1;e<=bytes;e++){
	                    ...
	                    //sdbm("extra new byte",char_unicode,string_byte_at(str,i+e)+256)
	                }
	                i+=bytes;
	                //sdbm(char_unicode);
	        ...
	        if dots_pos=0 then{
	            if total_width>=width_dots then{
	                dots_pos=i;
	            }else{
	            str_dots+=char_unicode;
	            }
	        }
	        //sdbm("width cehdng",total_width,width)
