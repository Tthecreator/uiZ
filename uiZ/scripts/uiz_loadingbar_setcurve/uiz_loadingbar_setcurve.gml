/// @description uiz_loadingbar_setcurve(instanceid,animation function constant,bool update )
/// @param instanceid
/// @param animation function constant
/// @param bool update 
function uiz_loadingbar_setcurve(argument0, argument1, argument2) {
