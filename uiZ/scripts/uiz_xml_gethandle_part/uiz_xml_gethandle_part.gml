/// @description uiz_xml_gethandle_part(file,tree,levels)
/// @param file
/// @param tree
/// @param levels
function uiz_xml_gethandle_part(argument0, argument1, argument2) {
	//get a handle
	...
	var t=argument1
	if ds_exists(t,ds_type_list) and (ds_list_empty(t) or ds_list_size(t)=0) then{return -5;}
	...
	//sdbm("loopend")
	//sdbm("return",i,lsz,level,levels)
