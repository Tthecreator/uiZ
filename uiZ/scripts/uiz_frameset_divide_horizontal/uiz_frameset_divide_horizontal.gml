/// @description uiz_frameset_divide_horizontal(object,divisionval,valuetype[px dp or fc],divisionval,valuetype[px dp or fc],........)
/// @param object
/// @param divisionval
...
/// @param valuetype[px dp or fc]
/// @param ........
function uiz_frameset_divide_horizontal() {
	/*
	...
	You cannot use this functi  on to change how the frameset is divided after it has been divided. You can only use this function to add new divisions and add new anchors.
	...
	*/
	var p=uiz_framedivisionhorizontal_part_beg(argument[0]);

	var divisions=(argument_count-1)/2;
	...
	uiz_framedivisionhorizontal_part_end(p, argument[0]);
	return p;
