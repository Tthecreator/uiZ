/// @description uiz_draw_line_width(x1, y1, x2,y 2, w, color, alpha)
/// @param x1
/// @param  y1
/// @param  x2
/// @param y 2
...
/// @param  color
/// @param  alpha
function uiz_draw_line_width(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
