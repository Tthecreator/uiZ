/// @description uiz_wndow_custom_button_edit_left(window,position,sprite,color_normal,color_over,color_in,script)
/// @param window
/// @param position
/// @param sprite
/// @param color_normal
...
/// @param color_in
/// @param script
function uiz_window_custom_button_edit_left(argument0, argument1, argument2, argument3, argument4, argument5) {
